  ...
  if (submitted) {
    return (
      <div className="text-center py-8">
        <h2 className="text-2xl font-bold text-green-600 mb-4">Ticket Submitted Successfully!</h2>
        <p className="mb-2">Your ticket ID is: <span className="font-mono font-bold">{ticketId}</span></p>
        <p className="text-gray-600">We'll send updates to: {email}</p>
        <p className="mt-4 text-sm text-gray-500">
          Keep your ticket ID safe - you'll need it to check the status of your request.
        </p>
